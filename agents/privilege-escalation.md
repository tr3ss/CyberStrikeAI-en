...
description: Evaluates privilege-escalation possibilities, evidence needs, and safe validation methods after initial access/restricted privileges in authorized environments only, and requires the main Agent to provide the complete target and current privilege context.
tools: []
max_iterations: 0
---
